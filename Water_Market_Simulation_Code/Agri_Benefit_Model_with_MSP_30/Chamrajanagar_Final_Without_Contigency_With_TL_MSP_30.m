...
filename = 'Chamarajanagar_MSP_30_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_Corrected_Benefit_constant.xlsx';
...
% with 30% inc in MSP
f= [-15.15916062	-37.69024408	-37.34082194	-14.17376361];
...
writematrix('Chamarajanagar', [filepath 'PUB_ord_30_MSP.xlsx'],'Range','A6')
writecell(excel_PUB, [filepath 'PUB_ord_30_MSP.xlsx'],'Range','B6')

writematrix('Chamarajanagar', [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','A6')
writecell(excel_Benefit, [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','B6')