...
filename = 'Mysore_MSP_30_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 30% inc in MSP
f=[-13.83991314	-33.47588755	-32.21151944	-13.9020597];
...
writematrix('Mysore', [filepath 'PUB_ord_30_MSP.xlsx'],'Range','A4')
writecell(excel_PUB, [filepath 'PUB_ord_30_MSP.xlsx'],'Range','B4')

writematrix('Mysore', [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','A4')
writecell(excel_Benefit, [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','B4')