...
filename = 'Tumkur_MSP_30_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 30% inc in MSP
f=[-12.39403485	-35.6197822	-26.24006755 -13.08696812];
...
writematrix('Tumkur', [filepath 'PUB_ord_30_MSP.xlsx'],'Range','A5')
writecell(excel_PUB, [filepath 'PUB_ord_30_MSP.xlsx'],'Range','B5')

writematrix('Tumkur', [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','A5')
writecell(excel_Benefit, [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','B5')