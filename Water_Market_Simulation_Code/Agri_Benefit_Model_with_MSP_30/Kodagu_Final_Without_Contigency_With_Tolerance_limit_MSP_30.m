...
filename = 'Kodagu_MSP_30_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 30% inc in MSP
f =[-11.38348825	-32.45922297	-37.15523792 0];
...
writematrix('Kodagu', [filepath 'PUB_ord_30_MSP.xlsx'],'Range','A2')
writecell(excel_PUB, [filepath 'PUB_ord_30_MSP.xlsx'],'Range','B2')
writematrix('Kodagu', [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','A2')
writecell(excel_Benefit, [filepath 'Benefit_ord_30_MSP.xlsx'],'Range','B2')