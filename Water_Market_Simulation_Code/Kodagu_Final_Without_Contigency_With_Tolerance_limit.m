...
filename = 'Kodagu_Final_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
writematrix('Kodagu', [filepath 'PUB_ord_Final.xlsx'],'Range','A2')
writecell(excel_PUB, [filepath 'PUB_ord_Final.xlsx'],'Range','B2')
writematrix('Kodagu', [filepath 'Benefit_ord_WA.xlsx'],'Range','A2')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA.xlsx'],'Range','B2')