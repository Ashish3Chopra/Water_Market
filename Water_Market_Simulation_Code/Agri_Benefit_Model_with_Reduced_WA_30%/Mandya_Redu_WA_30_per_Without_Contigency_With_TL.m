...
filename = 'Mandya_Agri_PUB_with_Redu_WA_30per.xlsx';
...
writematrix('Mandya', [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','A3')
writecell(excel_PUB, [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','B3')
writematrix('Mandya', [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','A3')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','B3')