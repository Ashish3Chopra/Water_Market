...
filename = 'Chamarajanagar_Agri_PUB_with_Redu_WA_30per.xlsx';
...
writematrix('Chamarajanagar', [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','A6')
writecell(excel_PUB, [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','B6')
writematrix('Chamarajanagar', [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','A6')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','B6')