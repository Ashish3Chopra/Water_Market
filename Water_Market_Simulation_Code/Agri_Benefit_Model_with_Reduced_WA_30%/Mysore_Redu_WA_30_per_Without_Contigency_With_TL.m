...
filename = 'Mysore_Agri_PUB_with_Redu_WA_30per.xlsx';
...
writematrix('Mysore', [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','A4')
writecell(excel_PUB, [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','B4')
writematrix('Mysore', [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','A4')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','B4')