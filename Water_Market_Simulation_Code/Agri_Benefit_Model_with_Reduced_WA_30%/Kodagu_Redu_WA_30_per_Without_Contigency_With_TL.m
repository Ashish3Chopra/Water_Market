...
filename = 'Kodagu_Agri_PUB_with_Redu_WA_30per.xlsx';
...
writematrix('Kodagu', [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','A2')
writecell(excel_PUB, [filepath 'PUB_ord_WA_30%_Red.xlsx'],'Range','B2')
writematrix('Kodagu', [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','A2')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_30%_Red.xlsx'],'Range','B2')