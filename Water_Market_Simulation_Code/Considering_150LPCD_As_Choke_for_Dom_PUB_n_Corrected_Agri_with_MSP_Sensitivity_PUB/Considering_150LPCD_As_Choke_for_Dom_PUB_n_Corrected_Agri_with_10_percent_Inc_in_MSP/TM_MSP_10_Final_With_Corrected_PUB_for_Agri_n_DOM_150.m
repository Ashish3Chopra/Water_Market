...
filepath = '/Users/ashish/OneDrive - Indian Institute of Science/MAC/Documents/MATLAB/Trade_Model_with_correct_Agri_n_Dom_PUB_Full/Considering_150LPCD_As_Choke_for_Dom_PUB_n_Corrected_Agri_with_MSP_Sensitivity_PUB/Considering_150LPCD_As_Choke_for_Dom_PUB_n_Corrected_Agri_with_10_percent_Inc_in_MSP/';
filename = 'Iteration_MSP_10_Agri_PUB_n_Dom_150_Pub.xlsx';
...
%  %to write the excel sheet using write matrix
   ...
   filename = 'Allocation_MSP_10_Agri_Dom_150_PUB.xlsx';
...
%   
   Excel_ResDistAllocFinal = cell2mat(ResDistAllocFinal(1,583));
   filename = 'Allocation_MSP_10_Agri_Dom_150_PUB.xlsx';
    Excel_Heading_Column=(1:13);
    Excel_Heading_Row={'R1'; 'R2'; 'R3'; 'R4'; 'R5';'R6'};
...
%   
   ...
   writecell(Excel_Heading_Column, 'Trade_final_with_MSP_10_Agri_Dom_150_PUB.xlsx', 'Sheet', 1, 'Range','B1');
   writematrix(Excel_Tradefinal,'Trade_final_with_MSP_10_Agri_Dom_150_PUB.xlsx', 'sheet',1,'Range','B2');
   Excel_Tradefinal_1=cell2mat(Tradefinal(1,583));
   writecell(Excel_Heading_Column, 'Trade_final_with_MSP_10_Agri_Dom_150_PUB.xlsx', 'Sheet', 2, 'Range','B1');
   writematrix(Excel_Tradefinal_1,'Trade_final_with_MSP_10_Agri_Dom_150_PUB.xlsx','sheet',2,'Range','B2');
...
% 
   writematrix(profit_sum, 'profit_sum_with_MSP_10_Agri_Dom_150_PUB.xlsx');
   writematrix(ProfitDist, 'Profit_Dist_with_MSP_10_Agri_Dom_150_PUB.xlsx');
   y=~cellfun(@isempty,Tradefinal);
   x=length(find(~cellfun(@isempty,Tradefinal)));
   writematrix(y,'Trade_possible_in_one_Iter_with_MSP_10_Agri_Dom_150_PUB.xlsx');
   writematrix(SellerDistOrignalPUB, 'Seller_Dist_with_MSP_10_Agri_Dom_150_PUB.xlsx');
   %to calculate the surplus directly
   writematrix(SurplusforSellerDist, 'Surplus_Dist_with_MSP_10_Agri_Dom_150_PUB.xlsx');
