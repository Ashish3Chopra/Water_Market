...
filename = 'Tumkur_Agri_PUB_with_Redu_WA_50per.xlsx';
...
writematrix('Tumkur', [filepath 'PUB_ord_WA_50%_Red.xlsx'],'Range','A5')
writecell(excel_PUB, [filepath 'PUB_ord_WA_50%_Red.xlsx'],'Range','B5')
writematrix('Tumkur', [filepath 'Benefit_ord_WA_50%_Red.xlsx'],'Range','A5')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_50%_Red.xlsx'],'Range','B5')