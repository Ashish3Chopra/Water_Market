...
filename = 'Chamarajanagar_Agri_PUB_with_Redu_WA_50per.xlsx';
...
writematrix('Chamarajanagar', [filepath 'PUB_ord_WA_50%_Red.xlsx'],'Range','A6')
writecell(excel_PUB, [filepath 'PUB_ord_WA_50%_Red.xlsx'],'Range','B6')
writematrix('Chamarajanagar', [filepath 'Benefit_ord_WA_50%_Red.xlsx'],'Range','A6')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_50%_Red.xlsx'],'Range','B6')