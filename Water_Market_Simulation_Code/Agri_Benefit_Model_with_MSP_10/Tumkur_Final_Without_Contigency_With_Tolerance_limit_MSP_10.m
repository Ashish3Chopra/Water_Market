...
filename = 'Tumkur_MSP_10_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 10% inc in MSP
f=[-10.033589	-29.20970665	-21.57719588	-10.5998671];
...
writematrix('Tumkur', [filepath 'PUB_ord_10_MSP.xlsx'],'Range','A5')
writecell(excel_PUB, [filepath 'PUB_ord_10_MSP.xlsx'],'Range','B5')

writematrix('Tumkur', [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','A5')
writecell(excel_Benefit, [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','B5')