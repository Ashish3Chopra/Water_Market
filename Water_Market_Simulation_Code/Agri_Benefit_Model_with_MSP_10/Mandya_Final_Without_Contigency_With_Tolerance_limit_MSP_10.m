...
filename = 'Mandya_MSP_10_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 10% inc in MSP
f =[-13.10708038	-35.36420095	-26.21168193	-16.00251274];
...
writematrix('Mandya', [filepath 'PUB_ord_10_MSP.xlsx'],'Range','A3')
writecell(excel_PUB, [filepath 'PUB_ord_10_MSP.xlsx'],'Range','B3')

writematrix('Mandya', [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','A3')
writecell(excel_Benefit, [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','B3')