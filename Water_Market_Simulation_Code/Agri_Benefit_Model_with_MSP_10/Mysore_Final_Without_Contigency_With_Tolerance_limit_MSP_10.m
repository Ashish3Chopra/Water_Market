...
filename = 'Mysore_MSP_10_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 10% inc in MSP
f=[-11.25702447	-27.39564194	-26.62996286	-11.28955998];
...
writematrix('Mysore', [filepath 'PUB_ord_10_MSP.xlsx'],'Range','A4')
writecell(excel_PUB, [filepath 'PUB_ord_10_MSP.xlsx'],'Range','B4')

writematrix('Mysore', [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','A4')
writecell(excel_Benefit, [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','B4')