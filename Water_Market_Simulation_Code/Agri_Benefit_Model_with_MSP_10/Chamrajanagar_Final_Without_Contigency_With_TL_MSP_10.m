...
% Mysore
% QP QR QM QS
filepath = '/Users/ashish/OneDrive - Indian Institute of Science/MAC/Documents/MATLAB/Agri_Benefit_Model/Agri_Benefit_Model_with_MSP_10/';
filename = 'Chamarajanagar_MSP_10_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_Corrected_Benefit_constant.xlsx';
...
% with 10% inc in MSP
f= [-12.3733108	-30.96163593	-30.9701419	-11.51946328];
...
writematrix('Chamarajanagar', [filepath 'PUB_ord_10_MSP.xlsx'],'Range','A6')
writecell(excel_PUB, [filepath 'PUB_ord_10_MSP.xlsx'],'Range','B6')

writematrix('Chamarajanagar', [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','A6')
writecell(excel_Benefit, [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','B6')