...
filename = 'Hassan_MSP_10_Final_without_ContArean_With_Tolerance_Lmt_With_Losses_n_Taluk_level_Benfwith2kItr_with_corrected_benefit_constant.xlsx';
...
%10 percent Ince in MSP
f = [-9.36510278 -29.24990912 -26.49633502 -11.26082315];
...
writematrix('Hassan', [filepath 'PUB_ord_10_MSP.xlsx'],'Range','A1')
writecell(excel_PUB, [filepath 'PUB_ord_10_MSP.xlsx'],'Range','B1')
writematrix('Hassan', [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','A1')
writecell(excel_Benefit, [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','B1')