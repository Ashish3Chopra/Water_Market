...
filename = 'Kodagu_MSP_10_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 10% inc in MSP
f =[-9.178511108 -26.5353873 -30.81310927 0];
...
writematrix('Kodagu', [filepath 'PUB_ord_10_MSP.xlsx'],'Range','A2')
writecell(excel_PUB, [filepath 'PUB_ord_10_MSP.xlsx'],'Range','B2')
writematrix('Kodagu', [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','A2')
writecell(excel_Benefit, [filepath 'Benefit_ord_10_MSP.xlsx'],'Range','B2')