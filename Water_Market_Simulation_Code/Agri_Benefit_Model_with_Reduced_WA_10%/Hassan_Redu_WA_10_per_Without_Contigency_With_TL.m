...
filename = 'Hassan_Agri_PUB_with_Redu_WA_10per.xlsx';
...
writematrix('Hassan', [filepath 'PUB_ord_WA_10%_Red.xlsx'],'Range','A1')
writecell(excel_PUB, [filepath 'PUB_ord_WA_10%_Red.xlsx'],'Range','B1')
writematrix('Hassan', [filepath 'Benefit_ord_WA_10%_Red.xlsx'],'Range','A1')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA_10%_Red.xlsx'],'Range','B1')