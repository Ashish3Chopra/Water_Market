...
filename = 'Hassan_MSP_50_Final_without_ContArean_With_Tolerance_Lmt_With_Losses_n_Taluk_level_Benfwith2kItr_with_corrected_benefit_constant.xlsx';
...
%50 percent Ince in MSP
f = [-13.84290859	-42.0846793	-37.61085624 -16.47537284];
...
writematrix('Hassan', [filepath 'PUB_ord_50_MSP.xlsx'],'Range','A1')
writecell(excel_PUB, [filepath 'PUB_ord_50_MSP.xlsx'],'Range','B1')
writematrix('Hassan', [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','A1')
writecell(excel_Benefit, [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','B1')