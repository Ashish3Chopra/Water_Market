...
filename = 'Kodagu_MSP_50_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 50% inc in MSP
f =[-13.5884654	-38.38305864	-43.49736657 0];
...
writematrix('Kodagu', [filepath 'PUB_ord_50_MSP.xlsx'],'Range','A2')
writecell(excel_PUB, [filepath 'PUB_ord_50_MSP.xlsx'],'Range','B2')
writematrix('Kodagu', [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','A2')
writecell(excel_Benefit, [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','B2')