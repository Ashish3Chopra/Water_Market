...
filename = 'Mysore_MSP_50_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
% with 50% inc in MSP
f=[-16.42280181	-39.55613315	-37.79307602	-16.51455942];
...
writematrix('Mysore', [filepath 'PUB_ord_50_MSP.xlsx'],'Range','A4')
writecell(excel_PUB, [filepath 'PUB_ord_50_MSP.xlsx'],'Range','B4')

writematrix('Mysore', [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','A4')
writecell(excel_Benefit, [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','B4')