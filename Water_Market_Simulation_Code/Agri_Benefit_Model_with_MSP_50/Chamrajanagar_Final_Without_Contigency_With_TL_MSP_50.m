...
filename = 'Chamarajanagar_MSP_50_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_Corrected_Benefit_constant.xlsx';
...
%with incorrect avg yield value
%f = [-1.6942 -5.1686 -6.5492 -10.192];
% BAse case
%f = [-10.98038589 -27.59733185 -27.78480188 -10.19231312];
% with 50% inc in MSP
f= [-17.94501043	-44.41885222	-43.71150199	-16.82806393];
...
writematrix('Chamarajanagar', [filepath 'PUB_ord_50_MSP.xlsx'],'Range','A6')
writecell(excel_PUB, [filepath 'PUB_ord_50_MSP.xlsx'],'Range','B6')

writematrix('Chamarajanagar', [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','A6')
writecell(excel_Benefit, [filepath 'Benefit_ord_50_MSP.xlsx'],'Range','B6')