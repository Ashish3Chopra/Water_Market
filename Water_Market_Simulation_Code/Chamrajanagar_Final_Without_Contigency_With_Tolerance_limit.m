...
% Mysore
% QP QR QM QS
filepath = '/Users/ashish/OneDrive - Indian Institute of Science/MAC/Documents/MATLAB/Agri_Benefit_Model/';
filename = 'Chamarajanagar_Final_without_ContArea_Without_Tolerance_Limit_With_Losses_and_Taluk_level_Benf_with_2kItr_with_Corrected_Benefit_constant.xlsx';
...
writematrix('Chamarajanagar', [filepath 'PUB_ord_Final.xlsx'],'Range','A6')
writecell(excel_PUB, [filepath 'PUB_ord_Final.xlsx'],'Range','B6')
writematrix('Chamarajanagar', [filepath 'Benefit_ord_WA.xlsx'],'Range','A6')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA.xlsx'],'Range','B6')