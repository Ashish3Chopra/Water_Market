...
filename = 'Hassan_Final_without_ContArean_With_Tolerance_Lmt_With_Losses_n_Taluk_level_Benfwith2kItr_with_corrected_benefit_constant.xlsx';
...
writematrix('Hassan', [filepath 'PUB_ord_Final.xlsx'],'Range','A1')
writecell(excel_PUB, [filepath 'PUB_ord_Final.xlsx'],'Range','B1')
writematrix('Hassan', [filepath 'Benefit_ord_WA.xlsx'],'Range','A1')
writecell(excel_Benefit, [filepath 'Benefit_ord_WA.xlsx'],'Range','B1')